 ...
 */
@WebServlet("/backoffice/asesinos-listar")
public class AsesinosListarController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		request.getRequestDispatcher("asesinos.jsp?page=asesinos").forward(request, response);
