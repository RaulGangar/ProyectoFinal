 ...
 */
@WebServlet("/backoffice/supervivientes-listar")
public class SupervivientesListarController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		request.getRequestDispatcher("supervivientes.jsp?page=supervivientes").forward(request, response);
