			...
			<div class="card">	<img src="${pIteracion.imagen}" alt="imagen avatar usuario" class="">
				<div class="card-body">
					...
					<p class="card-text">
						...
						<button type="button" class="btn btn-dark" data-bs-toggle="modal" data-bs-target="#modal${pIteracion.id}">
  						Leer mas.</button>
  						
						<div class="modal fade" id="modal${pIteracion.id}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  							<div class="modal-dialog">
    							<div class="modal-content">
      								<div class="modal-header">
        								<h5 class="modal-title" id="exampleModalLabel">${pIteracion.nombre}</h5>
        								<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      								</div>
      								<div class="modal-body">
        								<p>${pIteracion.historia}</p>
      								</div>
