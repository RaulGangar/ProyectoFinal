 ...
 */
@WebServlet("/backoffice/supervivientes-eliminar")
public class SupervivientesEliminarController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		request.getRequestDispatcher("supervivientes-listar").forward(request, response);
