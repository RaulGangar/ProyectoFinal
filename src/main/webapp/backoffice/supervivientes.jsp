...
<jsp:include page="../plantillas/menu.jsp"/>
 ...
 <main class="container">
    ...
    <a href="backoffice/supervivientes-editar?id=0">Nuevo Superviviente</a>
    
    <form action="backoffice/supervivientes-listar" method="get">
    ...
    <table class="table table-striped table-hover">
        ...
        <!-- 
        	...
        	items="$ { supervivientes}" => Nombre del atributo que nos envia en controlador
        	...
        	for ( Participante pIteracion : supervivientes )
        ...
        -->
	        ...
	        <c:forEach var="pIteracion" items="${supervivientes}">
	          <tr>
	            ...
	            <td><a href="backoffice/supervivientes-editar?id=${pIteracion.id}" class="btn btn-outline-primary">Editar</a></td>
	            <td><a onclick="confirmarEliminacion('${pIteracion.nombre}')" class="btn btn-outline-danger" href="backoffice/supervivientes-eliminar?id=${pIteracion.id}">Eliminar</a></td>
	          </tr>
	         </c:forEach> 
